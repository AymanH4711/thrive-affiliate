...
export default function MetabolicWeightCategory() {
  ...
  const categoryData = {
    ...
    products: [
      ...
      },
      {
        ...
        tagline: "Energy & Recovery Support",
        description: "Magnesium regulates metabolism and energy production. Glycinate form is highly absorbable and gentle on digestion.",
        benefits: ["Supports metabolic function", "Improves sleep quality", "Reduces muscle tension"],
        recommendedBrand: "Thorne Magnesium Glycinate",
        affiliateLink: "https://amzn.to/placeholder_magnesium",
        rating: 4.8,
        icon: Heart
      }
    ]
  ...
  const colorStyles = {
    blue: {
      ...
      tab: 'bg-blue-100 text-blue-700 ring-2 ring-blue-500',
  ...
  const schema = {
    ...
    "@type": "Product",
    "name": "Metabolic & Weight Support Supplements",
    "description": "Supplements for metabolic health and weight management"
  };

  return (
    <>
      <SEO
        title="Metabolic & Weight Support Supplements | Green Tea"
        description="Supplements for metabolic health and weight management: Green Tea Extract (EGCG), Magnesium Glycinate. Boost metabolism, support fat loss, stabilize blood sugar."
        keywords="metabolic support supplements, weight loss supplements, green tea extract, magnesium supplement"
        image="/images/metabolic-weight-og.png"
      ...
      <main className="min-h-screen bg-gray-50 font-sans text-gray-800">
        ...
        <section className={`bg-gradient-to-br ${colors.bgGradient} text-white pt-24 pb-16`}>
          <div className="container mx-auto px-4 text-center max-w-4xl">
            <Link to="/supplements" className={`inline-flex items-center text-blue-200 hover:text-white mb-6 transition`}>
