...
export default function GeneralWellnessCategory() {
  const schema = {
    ...
    "@type": "Product",
    "name": "General Wellness Supplements",
    "description": "General wellness supplements for overall health and vitality"
  };
  ...
  const categoryData = {
    ...
    description: 'Comprehensive support for longevity, inflammation reduction, and healthy aging.',
    colorClass: 'teal',
    icon: ShieldCheck,
    ...
    products: [
      {
        id: "resveratrol",
        name: "Resveratrol",
        tagline: "Longevity & Anti-Aging Support",
        description: "A powerful polyphenol found in red grapes that activates sirtuins–genes associated with healthy aging and longevity.",
        benefits: ["Supports cardiovascular health", "Powerful antioxidant", "May promote longevity pathways"],
        recommendedBrand: "Bionutrics Resveratrol Premium",
        affiliateLink: "https://amzn.to/placeholder_resveratrol",
        rating: 4.4,
        icon: Heart
      }
    ]
  ...
  const colorStyles = {
    teal: {
      ...
      tab: 'bg-teal-100 text-teal-700 ring-2 ring-teal-500',
  ...
  return (
    <>
      <SEO
        title="General Wellness Supplements | Resveratrol & More"
        description="General wellness supplements for overall health: Resveratrol for antioxidant support, anti-aging benefits, and cellular health. Science-backed recommendations."
        keywords="wellness supplements, resveratrol supplement, antioxidant supplements, general health"
        image="/images/wellness-og.png"
