// src/pages/seniors-glucose-monitoring.tsx
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-2 md:order-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/categories/seniors-glucose" className="inline-flex items-center justify-center gap-2 border-2 border-emerald-600 text-emerald-600 font-semibold px-6 py-3 rounded-lg hover:bg-emerald-50 transition">
                  Browse Resources
                </Link>
              </div>
            </div>
          ...
          <section id="why-matters" className="mb-16">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-8 my-6">
              ...
              <div className="space-y-4">
                {[
                  {
                    title: 'Reduced Insulin Sensitivity',
                    desc: 'Cells become less responsive to insulin with age'
                  },
                  {
                    title: 'Muscle Loss',
                    desc: 'Less muscle means reduced glucose storage capacity'
                  },
                  {
                    title: 'Medication Interactions',
                    desc: 'Multiple medications can affect blood sugar'
                  },
                  {
                    title: 'Slower Symptom Recognition',
                    desc: 'High blood sugar symptoms may be mistaken for aging'
                  },
                ].map((item, i) => (
          ...
          <section className="mb-16">
            <div className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white rounded-2xl p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link to="/categories/glucose-monitoring" className="inline-flex items-center gap-2 bg-emerald-700 text-white font-semibold px-8 py-3 rounded-lg hover:bg-emerald-800 transition border-2 border-white">
