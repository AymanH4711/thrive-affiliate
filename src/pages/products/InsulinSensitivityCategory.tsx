    ...
    products: [
      {
        ...
        benefits: ["Supports reduced insulin resistance (HOMA-IR) — effects are dose- and duration-dependent", "Powerful antioxidant protection", "Supports nerve and metabolic health"],
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-800 leading-relaxed font-semibold">
                    The information on this page is for <strong>educational purposes only</strong> and does not constitute medical advice. These statements have not been evaluated by the U.S. Food and Drug Administration (FDA). No supplement listed here is intended to diagnose, treat, cure, or prevent any disease. These products are not a substitute for prescribed diabetes medications or a balanced diet and lifestyle. <strong>Always consult a qualified healthcare provider before starting any supplement</strong>, especially if you have diabetes, prediabetes, or any other health condition, or are taking medications for blood sugar or insulin resistance — some supplements can interact with glucose-lowering medications or affect insulin levels. Individual results vary and are not guaranteed.
                  </p>
                </div>
              </div>
            </div>
